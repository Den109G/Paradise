...
/obj/machinery/portable_atmospherics/scrubber/ui_interact(mob/user, datum/tgui/ui = null, force_open = FALSE)
	ui = SStgui.try_update_ui(user, src, ui, force_open)
	if(!ui)
		ui = new(user, src, "PortableScrubber", "Portable Scrubber", 433, 346)
		ui.open()
