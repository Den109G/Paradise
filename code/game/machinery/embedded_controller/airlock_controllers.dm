...
/obj/machinery/embedded_controller/radio/airlock/airlock_controller/ui_state(mob/user)
	return GLOB.default_state

/obj/machinery/embedded_controller/radio/airlock/airlock_controller/ui_interact(mob/user, datum/tgui/ui = null, force_open = FALSE)
...
/obj/machinery/embedded_controller/radio/airlock/access_controller/ui_state(mob/user)
	return GLOB.default_state

/obj/machinery/embedded_controller/radio/airlock/access_controller/ui_interact(mob/user, datum/tgui/ui = null, force_open = FALSE)
	ui = SStgui.try_update_ui(user, src, ui, force_open)
	if(!ui)
