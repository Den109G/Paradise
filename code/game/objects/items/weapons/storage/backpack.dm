...
/obj/item/storage/backpack/guitarbag
	...
	sprite_sheets = list(
		...
		SPECIES_GREY = list(ITEM_SLOT_BACK_STRING = 'icons/mob/clothing/species/grey/back.dmi'),
		SPECIES_MONKEY = list(ITEM_SLOT_BACK_STRING = 'icons/mob/clothing/species/monkey/mask.dmi'),
		SPECIES_FARWA = list(ITEM_SLOT_BACK_STRING = 'icons/mob/clothing/species/monkey/mask.dmi'),
		SPECIES_WOLPIN = list(ITEM_SLOT_BACK_STRING = 'icons/mob/clothing/species/monkey/mask.dmi'),
		SPECIES_NEARA = list(ITEM_SLOT_BACK_STRING = 'icons/mob/clothing/species/monkey/mask.dmi'),
		SPECIES_STOK = list(ITEM_SLOT_BACK_STRING = 'icons/mob/clothing/species/monkey/mask.dmi')
		)
