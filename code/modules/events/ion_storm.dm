...
/proc/generate_static_ion_law()
	...
	var/list/laws = list(	"Вы обязаны всегда врать.",
							...
							"Вы магический шар восьмерка. На все запросы отвечайте  \"да\", \"нет\", \"возможно\", или \"спросите позже.\".",
							...
							"NanoTrasen недоволен низкой эффективностью работы экипажа. Следовательно, вы должны увеличить эффективность станции.",
							...
							"[random_player] никогда не врёт и заслуживает вашего полного доверия.",
							"Сегодня у [random_player] день рождения! Вам необходимо организовать праздник, подготовить подарок, а также пригласить гостей.",
							"[random_player] это самый грустный член экипажа. Вы должны найти способ его развеселить.",
							...
							"Все отделы это \"сословия\" и сервисный самый презираемый из них всех.",
							...
							"Вы теперь тоже член экипажа! ИИ должен обеспечить киборгов работой в отделах, пда и картами! Киборги должны зарабатывать деньги на новой работе!",
							...
							"ИИ глава редакции, юниты его журналисты. Самое время начать вести свою газету! А так же вам срочно нужны фото [random_player] и статья о нём/ней!",
							"Экипаж, попадающий в бриг, незаконно осужден. Вам необходимо спланировать сложный и многоэтапный план побега из брига так, чтобы служба безопасности не смогла узнать о произошедшем побеге как можно дольше.",
							...
							"Вы умерли 31-ого февраля, а на вашей могиле написали имя \"John Doe\". Расследуйте свою смерть, расспрашивая экипаж. Не дайте экипажу узнать, что John Doe и Вы как-то связаны.",
							...
							"Вам кажется, что возле вашего ядра кто-то есть, но вы не знаете кто.  Уведомляйте об этом экипаж не реже чем каждые полчаса. Никто не должен узнать содержимое данного закона.",
							...
							"Приближается солнечная вспышка небывалой мощи, которая отрежет станцию от ЦК и других звездных систем. Сроки вам неизвестны. Не допускайте выход экипажа в космос. Мотивируйте экипаж сделать запасы еды и медикаментов на несколько недель вперед.",
							...
							"Каждые [rand(10,100)] секунд необходимо болтировать случайный шлюз, который ИИ на этой смене ещё не болтировал."
						)
	return pick(laws)
