...
#define BLOCK_Z_OUT_DOWN		(1<<0)  // Should this object block z falling from loc?
#define BLOCK_Z_OUT_UP			(1<<1) // Should this object block z uprise from loc?
#define BLOCK_Z_IN_DOWN			(1<<2) // Should this object block z falling from above?
#define BLOCK_Z_IN_UP			(1<<3) // Should this object block z uprise from below?
